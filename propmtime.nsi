...
# *** DO NOT EDIT ***
# Programmatically generated by pyship on 2020-11-02 23:06:24.912432.
...
!define INSTALLSIZE 443860.4033203125
...
section "install"
  ...
  createShortCut "$SMPROGRAMS\${COMPANYNAME}\${APPNAME}.lnk" "$INSTDIR\${APPNAME}\${EXENAME}" "" "$INSTDIR\${APPNAME}.ico"

  # run on Windows startup
  WriteRegStr HKEY_LOCAL_MACHINE "Software\Microsoft\Windows\CurrentVersion\Run" "${APPNAME}" "$INSTDIR\${EXENAME}"
